...
import yaml
# 添加项目路径
project_root = Path(__file__).parent.parent.parent  # 获取 VIVTransformer-4sh2r1-codex 根目录
...
# 添加 modify_multi_attention 目录到路径
