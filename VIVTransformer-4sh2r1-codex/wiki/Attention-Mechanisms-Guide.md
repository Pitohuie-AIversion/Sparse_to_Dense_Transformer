...
### 2. Simplified Self Attention (简化自注意力)
...
### 3. MUSE (Multi-Scale Efficient Attention)
...
### 4. UFO (Unified Feature Operation)
...
### 6. LSH (Locality Sensitive Hashing) Attention
...
### 11. EMSA (Efficient Multi-Scale Attention)
...
### 12. DAT (Dual Attention Transformer)
...
### 16. SE (Squeeze-and-Excitation) Attention
...
### 17. SK (Selective Kernel) Attention
...
### 19. BAM (Bottleneck Attention Module)
...
### 20. ECA (Efficient Channel Attention)
...
### 21. PSA (Point-wise Spatial Attention)
...
### 22. DANet (Dual Attention Network)
...
### 27. A2 (Attention Augmented) Attention
...
### 30. AFT (Attention Free Transformer)
